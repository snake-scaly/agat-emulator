...
Root: HKCR; Subkey: "AppleHDD"; ValueType: string; ValueName: ""; ValueData: "Apple ][ Hard Disk Image"; Flags: uninsdeletekey; Tasks: registerdsk; Languages: en
Root: HKCR; Subkey: "AppleHDD"; ValueType: string; ValueName: ""; ValueData: "Образ жёсткого диска Apple ]["; Flags: uninsdeletekey; Tasks: registerdsk; Languages: ru
Root: HKCR; Subkey: "AppleHDD\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\emulator.exe,1"; Tasks: registerdsk
Root: HKCR; Subkey: "AppleHDD\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\emulator.exe"" ""(3i) CMS SCSI"" -cd ""{app}"" -fs 1 -s7d0 ""%1"""; Tasks: registerdsk
...
Root: HKCR; Subkey: ".hdv"; ValueType: string; ValueName: ""; ValueData: "AppleHDD"; Flags: uninsdeletevalue; Tasks: registerdsk
