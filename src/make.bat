...
set LIBS=video\libvideo.lib cpu\libcpu.lib sound\libsound.lib tape\libtape.lib joystick\libjoystick.lib fdd\libfdd.lib softcard\libsoftcard.lib clock\libclock.lib
